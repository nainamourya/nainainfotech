...
export default function WebsiteDesign() {
  ...
  return (
    <>
      <Helmet>
        <title>
          Website Design Services in India | High-Converting Websites – Naina
          Infotech
        </title>
        <meta
          name="description"
          content="Naina Infotech provides modern website design services focused on speed, SEO, and conversions. We build high-performance websites for growing businesses."
        />
        <link
          rel="canonical"
          href="https://www.nainainfotech.com/services/website-design"
        />
      </Helmet>
      <section
        ref={sectionRef}
      ...
      >
        ...
        <section className="bg-black/40 py-20">
          <div className="max-w-4xl mx-auto px-6 text-gray-300 text-sm leading-relaxed space-y-4">
            <h2 className="text-2xl font-semibold text-white">
              Professional Website Design Services
            </h2>
            <p className="mt-6 text-lg md:text-xl text-gray-300">
              Naina Infotech offers modern website design services for
              businesses that want more than just an online presence. We build
              high-converting, SEO-ready, and performance-optimized websites
              using modern frameworks, Tailwind CSS, and conversion-focused UX.
            </p>
            <p className="mt-6 text-lg md:text-xl text-gray-300">
              Our websites are designed to load fast, look premium, and guide
              users toward action. Every layout, animation, and interaction is
              crafted to support business goals such as lead generation, brand
              trust, and online growth.
            </p>
            <p className="mt-6 text-lg md:text-xl text-gray-300">
              Whether you need a landing page, business website, or full-scale
              digital platform, our website design process ensures clarity,
